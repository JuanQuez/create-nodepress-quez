...
console.log(
    ...
    "               █▄▄█ █▄▄▄█ ▄              \n" +
    "                                         \n"+
    "         \x1b[1m\x1b[32m¡TU CREACION ESTA LISTA!\x1b[0m\n" +
    "                                          \n"+
    `   Ingresa \x1b[1m\x1b[36m\x1b[40m"cd ${repoName}"\x1b[0m y despues "code ."\n` +
`  No olvides crear tu base de datos y agregarla \n` +
`              En el archivo \x1b[1m\x1b[36m\x1b[40m".env"\x1b[0m\n`
)
